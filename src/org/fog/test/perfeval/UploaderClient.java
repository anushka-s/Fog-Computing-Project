...
public class UploaderClient extends JFrame {
...
private JLabel sendinglabel1;
   ...
   public static void main(String[] args){
      UploaderClient  swingControlDemo = new UploaderClient();      
   ...
   public void showProgressBarDemo(){
      ...
      ProgressMonitor pc=new ProgressMonitor(UploaderClient.this, "Running My Program","", 0,10);
    ...
    public void run(){       
        ...
        if(filename!=null)
        {
         ...
         try{
            ...
            UploaderClient.this.starttime.setText("Start time: "+starttime);
            ...
            JOptionPane.showMessageDialog(rootPane, "File is Sending...!!!");
                ...
                UploaderClient.this.endtime.setText(endtime);
